...
WFI_args = {"PSFs": PSFs, "source_dir": wfirst_path + "/scripts/pixel-level/input/",
            "pixel_scale": 0.11, "dark_current": 0.015,
            "IPC": 0.02,
            "TTel": TTel,
            "zodi_fl": file_to_fn(wfirst_path + "/scripts/pixel-level/input/aldering.txt"),
            "bad_pixel_rate": 0.01,
...
effective_meters2_fl = file_to_fn(wfirst_path + "/scripts/pixel-level/input/" + filt + ".txt")
